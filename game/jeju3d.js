...
const INTRO_LINES = [
  ...
  '평생 모은 돈으로 서울에 작은 아파트 하나 사는 것이 꿈이었다. 하지만 집값은 월급보다, 저축보다, 꿈보다 훨씬 빠르게 올라갔다.',
  '결국 루루는 포기했다. 전 재산 4,000만 원 — 그 돈으로 살 수 있는 집은 서울에 없었다.',
  '루루는 마지막 희망을 품고 제주도로 내려왔다. 그리고 전 재산을 털어, 사람이 떠난 외딴 마을의 빈집 하나를 샀다.',
  '집은 비가 새고, 전기는 끊겼고, 잡초는 허리까지 자라 있었다. 하지만 루루는 웃었다.',
  '"적어도… 여긴 내 집이다."',
  '그날부터 루루의 두 번째 인생이 시작된다. 농사를 짓고, 집을 고치고, 이웃과 정을 나누며 — 언젠가 이 낡은 집을 제주 최고의 집으로 만드는 것. 그것이 루루의 새로운 꿈이다. 🍊',
];
